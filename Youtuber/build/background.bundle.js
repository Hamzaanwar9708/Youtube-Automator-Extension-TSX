...
function initMultipleProcessing() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (multipleIsRange) {
            ...
            if (subscribe.find((i) => i.id === current.id))
                acts.push('Subscribe');
            if (like.find((i) => i.id === current.id))
                acts.push('Like');
            if (comment.find((i) => i.id === current.id))
                acts.push('Comment');
            if (acts.length === 0)
                acts = ['Notify'];
        }
...
function initPlaylistProcessing() {
    return __awaiter(this, void 0, void 0, function* () {
...
function initChannelProcessing() {
    return __awaiter(this, void 0, void 0, function* () {
...
function generateAIComment(videoTitle) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield fetch('https://api.groq.com/openai/v1/chat/completions', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        {
                            role: 'system',
                            content: 'You are an AI assistant that generates engaging YouTube comments as thoughtful and positive a critic on my behalf.',
                        },
                        {
                            role: 'user',
            ...
            return ((_a = data.choices[0]) === null || _a === void 0 ? void 0 : _a.message.content.trim()) || null;
        }
        catch (_b) {
            return null;
        }
