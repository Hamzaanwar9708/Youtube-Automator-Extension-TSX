...
const FilterSection = ({ onSectionChange, goBack, rememberPrevious }) => {
    ...
    const validate = () => {
        ...
        ranges.forEach(range => {
            var _a, _b;
            const min = Number(((_a = document.getElementById(`${range}-min`)) === null || _a === void 0 ? void 0 : _a.value) || nu);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("26e582251489f5fc9edb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=contentScript.480e9e64f80a230f87b6.hot-update.js.map